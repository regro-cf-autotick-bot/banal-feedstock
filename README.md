...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/banal-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=12134&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/banal-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `banal` can be installed with:

```
conda install banal
```

It is possible to list all of the versions of `banal` available on your platform with:
